...
namespace Kinvey
{
	internal class KinveyQueryVisitor : QueryModelVisitorBase
	{
		IQueryBuilder builderMongoQuery;
		Dictionary<string, string> mapPropertyToName;
        VisitorClause clause;
		...
		public override void VisitWhereClause(WhereClause whereClause, QueryModel queryModel, int index)
		{
            ...
            if (clause.HasFlag(VisitorClause.Where))
            {
		...
		public override void VisitSelectClause(SelectClause selectClause, QueryModel queryModel)
		{
            ...
            if (clause.HasFlag(VisitorClause.Select))
            {
