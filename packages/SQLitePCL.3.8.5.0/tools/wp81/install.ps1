...
Write-Host "Please, verify that the extension SDK SQLite for Windows Phone v3.8.5, from the SQLite.org site (http://www.sqlite.org/2014/sqlite-wp81-winrt-3080500.vsix), has been properly installed."
